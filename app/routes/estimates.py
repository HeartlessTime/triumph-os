...
async def new_estimate_form(
    ...
    try:
        ...
        return templates.TemplateResponse("demo_mode_notice.html", {
            ...
            "message": "Database error: Unable to load opportunity. Please ensure your database is properly initialized.",
...
async def view_estimate(
    ...
    try:
        ...
        return templates.TemplateResponse("demo_mode_notice.html", {
            ...
            "message": "Database error: Unable to load estimate. Please ensure your database is properly initialized.",
            "back_url": "/opportunities",
        })
