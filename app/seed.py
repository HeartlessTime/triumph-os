...
def seed_database():
    ...
    try:
        ...
        vendors = [
            Vendor(name="ABC Electrical Supply", contact_name="John Smith", email="john@abcelectric.com", phone="555-111-2222", specialty="Electrical"),
            Vendor(name="Quality Plumbing Co", contact_name="Jane Doe", email="jane@qualityplumb.com", phone="555-222-3333", specialty="Plumbing"),
            Vendor(name="Steel Masters Inc", contact_name="Bob Steel", email="bob@steelmasters.com", phone="555-333-4444", specialty="Steel"),
            Vendor(name="Concrete Solutions", contact_name="Mary Mason", email="mary@concretesol.com", phone="555-444-5555", specialty="Concrete"),
        ]
        db.add_all(vendors)
        db.flush()
        ...
        contacts = [
            # Acme contacts
            Contact(account_id=accounts[0].id, first_name="Robert", last_name="Johnson", title="Facilities Director", email="rjohnson@acme.example.com", phone="555-100-1001", is_primary=True),
            Contact(account_id=accounts[0].id, first_name="Lisa", last_name="Williams", title="Project Manager", email="lwilliams@acme.example.com", phone="555-100-1002"),
            # TechStart contacts
            Contact(account_id=accounts[1].id, first_name="David", last_name="Chen", title="CEO", email="dchen@techstart.example.com", phone="555-200-2001", is_primary=True),
            Contact(account_id=accounts[1].id, first_name="Emily", last_name="Park", title="Operations Manager", email="epark@techstart.example.com", phone="555-200-2002"),
            # Hospital contacts
            Contact(account_id=accounts[2].id, first_name="Dr. James", last_name="Wilson", title="Chief Administrator", email="jwilson@cityhospital.example.com", phone="555-300-3001", is_primary=True),
            # School contacts
            Contact(account_id=accounts[3].id, first_name="Patricia", last_name="Davis", title="Superintendent", email="pdavis@summit.example.com", phone="555-400-4001", is_primary=True),
        ]
        db.add_all(contacts)
        db.flush()
        ...
        line_items = [
            # TechStart v1
            EstimateLineItem(estimate_id=estimates[0].id, line_type="labor", description="Demolition crew", quantity=Decimal("120"), unit="hour", unit_cost=Decimal("65"), sort_order=1),
            EstimateLineItem(estimate_id=estimates[0].id, line_type="labor", description="Electrical installation", quantity=Decimal("200"), unit="hour", unit_cost=Decimal("85"), sort_order=2),
            ...
            EstimateLineItem(estimate_id=estimates[1].id, line_type="labor", description="HVAC installation", quantity=Decimal("140"), unit="hour", unit_cost=Decimal("90"), sort_order=3),
            EstimateLineItem(estimate_id=estimates[1].id, line_type="labor", description="Drywall and finishing", quantity=Decimal("240"), unit="hour", unit_cost=Decimal("55"), sort_order=4),
            ...
            EstimateLineItem(estimate_id=estimates[2].id, line_type="labor", description="Plumbing", quantity=Decimal("600"), unit="hour", unit_cost=Decimal("85"), sort_order=3),
            EstimateLineItem(estimate_id=estimates[2].id, line_type="labor", description="Medical gas systems", quantity=Decimal("400"), unit="hour", unit_cost=Decimal("110"), sort_order=4),
            EstimateLineItem(estimate_id=estimates[2].id, line_type="material", description="Construction materials", quantity=Decimal("1"), unit="lot", unit_cost=Decimal("450000"), sort_order=5),
            EstimateLineItem(estimate_id=estimates[2].id, line_type="material", description="Electrical systems", quantity=Decimal("1"), unit="lot", unit_cost=Decimal("180000"), sort_order=6),
            EstimateLineItem(estimate_id=estimates[2].id, line_type="material", description="Medical equipment infrastructure", quantity=Decimal("1"), unit="lot", unit_cost=Decimal("320000"), sort_order=7),
        ]
